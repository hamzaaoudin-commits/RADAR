    ...
    <section className="section-hero grain pb-16 pt-40">
      ...
      <div className="shell-md relative">
        ...
        <p className="lede mx-auto mb-4 max-w-[640px]">
          Chaque lundi, le journal de votre marché : tout ce qui a bougé en une
          semaine, en un seul endroit. Vous n&apos;ouvrez plus rien d&apos;autre — et
          votre attention retourne là où elle compte.
        </p>
